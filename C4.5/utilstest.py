...
class TestDataMinig(unittest.TestCase):
    ...
    def test_del_values(self):
        ...
        self.assertEquals(utils.del_values(self.table, [0, 2]), expected)
        expected = {
            'result': [],
            'arg1': [],
            'arg2': [],
        ...
        self.assertEquals(utils.del_values(self.table, []), expected)
        expected = {
            'result': ['yes', 'yes', 'no'],
        ...
        self.assertEquals(utils.del_values(self.table, [0, 2, 3]), expected)
